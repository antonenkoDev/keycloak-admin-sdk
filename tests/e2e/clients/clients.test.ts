...
describe('Clients API E2E Tests', () => {
  ...
  test('should find all clients in a realm', async () => {
    try {
      ...
      console.error(
        `Error finding clients: ${error instanceof Error ? error.message : String(error)}`
      );
      throw error;
    }
  });
  ...
  test('should find a client by ID', async () => {
    ...
    try {
      ...
      console.error(
        `Error finding client by ID: ${error instanceof Error ? error.message : String(error)}`
      );
      throw error;
    }
  });
  ...
  test('should get client secret', async () => {
    ...
    try {
      ...
      console.error(
        `Error getting client secret: ${error instanceof Error ? error.message : String(error)}`
      );
      throw error;
    }
  });
  ...
  test('should generate a new client secret', async () => {
    ...
    try {
      ...
      console.error(
        `Error generating client secret: ${error instanceof Error ? error.message : String(error)}`
      );
      throw error;
    }
  });
  ...
  test('should get default client scopes', async () => {
    ...
    try {
      ...
      console.error(
        `Error getting default client scopes: ${error instanceof Error ? error.message : String(error)}`
      );
      throw error;
    }
  });
  ...
  test('should get optional client scopes', async () => {
    ...
    try {
      ...
      console.error(
        `Error getting optional client scopes: ${error instanceof Error ? error.message : String(error)}`
      );
      throw error;
    }
  });
  ...
  test('should create a new client', async () => {
    try {
      ...
      console.error(
        `Error in create client test: ${error instanceof Error ? error.message : String(error)}`
      );
  ...
  test('should delete a client', async () => {
    ...
    try {
      ...
      console.error(
        `Error deleting client: ${deleteError instanceof Error ? deleteError.message : String(deleteError)}`
      );
