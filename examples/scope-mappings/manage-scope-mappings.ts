...
// Import the ClientScopeRepresentation from the SDK
import { ClientScopeRepresentation } from '../../src/types/client-scopes';

// If the import fails, uncomment this interface definition:
/*
...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.log(`Created test role: ${testRoleName} (${roleId}) - ID extracted from Location header`);
    ...
    try {
      ...
      console.log(`Created test client scope: ${testClientScopeName} (${clientScopeId}) - ID extracted from Location header`);
    } catch (error) {
    ...
    try {
      ...
      console.log('Available realm scope mappings:', JSON.stringify(availableRealmScopeMappings, null, 2));
    } catch (error) {
    ...
    try {
      ...
      console.log('Effective realm scope mappings:', JSON.stringify(effectiveRealmScopeMappings, null, 2));
    } catch (error) {
    ...
    if (!targetClient || !targetClient.id) {
      ...
      try {
        ...
        try {
          ...
          console.log('Available client scope mappings:', JSON.stringify(availableClientScopeMappings, null, 2));
        } catch (error) {
        ...
        try {
          ...
          console.log(`Added client role ${clientRole.name} to client ${client!.clientId} scope mappings`);
        } catch (error) {
        ...
        try {
          ...
          console.log('Client level scope mappings:', JSON.stringify(clientLevelScopeMappings, null, 2));
        } catch (error) {
        ...
        try {
          ...
          console.log('Effective client scope mappings:', JSON.stringify(effectiveClientScopeMappings, null, 2));
        } catch (error) {
        ...
        try {
          ...
          console.log(`Removed client role ${clientRole.name} from client ${client!.clientId} scope mappings`);
        } catch (error) {
    ...
    try {
      ...
      try {
        ...
        console.log('Client scope realm mappings:', JSON.stringify(clientScopeRealmMappings, null, 2));
      } catch (error) {
    ...
    try {
      ...
      if (testRoleName) {
        ...
        try {
          ...
          console.warn(`Failed to delete test role: ${error instanceof Error ? error.message : error}`);
        }
      }
      ...
      if (clientScopeId) {
        ...
        try {
          ...
          console.warn(`Failed to delete test client scope: ${error instanceof Error ? error.message : error}`);
        }
      }
