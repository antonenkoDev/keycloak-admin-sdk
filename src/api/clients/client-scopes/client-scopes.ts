...
export class ClientScopesApi {
  ...
  async findAll(): Promise<ClientScopeRepresentation[]> {
    try {
      ...
      throw new Error(
        `Failed to get client scopes: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async create(clientScope: ClientScopeRepresentation): Promise<string> {
    ...
    try {
      ...
      return await this.sdk.request<string>('/client-scopes', 'POST', clientScope);
    } catch (error) {
      throw new Error(
        `Failed to create client scope: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async findById(id: string): Promise<ClientScopeRepresentation> {
    ...
    try {
      ...
      throw new Error(
        `Failed to get client scope: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async update(id: string, clientScope: ClientScopeRepresentation): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to update client scope: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getProtocolMappers(id: string): Promise<ProtocolMapperRepresentation[]> {
    ...
    try {
      return this.sdk.request<ProtocolMapperRepresentation[]>(
        `/client-scopes/${id}/protocol-mappers/models`,
        'GET'
      );
    } catch (error) {
      throw new Error(
        `Failed to get protocol mappers: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async createProtocolMapper(id: string, mapper: ProtocolMapperRepresentation): Promise<string> {
    ...
    try {
      ...
      throw new Error(
        `Failed to create protocol mapper: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getProtocolMapper(id: string, mapperId: string): Promise<ProtocolMapperRepresentation> {
    ...
    try {
      return this.sdk.request<ProtocolMapperRepresentation>(
        `/client-scopes/${id}/protocol-mappers/models/${mapperId}`,
        'GET'
      );
    } catch (error) {
      throw new Error(
        `Failed to get protocol mapper: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async updateProtocolMapper(
    ...
    try {
      ...
      if (error instanceof Error) {
        throw new Error(
          `Failed to update protocol mapper: ${error.message}${error.stack ? '\n' + error.stack : ''}`
        );
      } else {
  ...
  async deleteProtocolMapper(id: string, mapperId: string): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to delete protocol mapper: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
}
