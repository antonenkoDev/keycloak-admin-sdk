...
export class RealmsApi {
     ...
     * @throws {Error} If the request fails or realmName is invalid
     */
    async getClientSessionStats(realmName: string): Promise<Array<{id: string, active: number}>> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }

        try {
            return this.sdk.requestForRealm<Array<{id: string, active: number}>>(realmName, '/client-session-stats', 'GET');
        } catch (error) {
     ...
     * @throws {Error} If the request fails or realmName is invalid
     */
    async getClientPolicies(realmName: string, includeGlobalPolicies?: boolean): Promise<ClientPoliciesRepresentation> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async updateClientPolicies(realmName: string, policies: ClientPoliciesRepresentation): Promise<void> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
        ...
        try {
            ...
            await this.sdk.requestForRealm<void>(realmName, '/client-policies/policies', 'PUT', sanitizedPolicies);
        } catch (error) {
            // Provide more context about the error
            if (error instanceof Error && error.message.includes('404')) {
                throw new Error(`Client policies endpoint not available in this Keycloak version for realm ${realmName}. This feature may require Keycloak 12+ or Enterprise.`);
     ...
     * @throws {Error} If the request fails or realmName is invalid
     */
    async getClientProfiles(realmName: string, includeGlobalProfiles?: boolean): Promise<ClientProfilesRepresentation> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async updateClientProfiles(realmName: string, profiles: ClientProfilesRepresentation): Promise<void> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
        ...
        try {
            ...
            await this.sdk.requestForRealm<void>(realmName, '/client-policies/profiles', 'PUT', sanitizedProfiles);
        } catch (error) {
            // Provide more context about the error
            if (error instanceof Error && error.message.includes('404')) {
                throw new Error(`Client profiles endpoint not available in this Keycloak version for realm ${realmName}. This feature may require Keycloak 12+ or Enterprise.`);
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async updateClientTypes(realmName: string, clientTypes: ClientTypesRepresentation): Promise<void> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
    ...
    async getUsersManagementPermissions(realmName: string): Promise<ManagementPermissionReference> {
        ...
        try {
            return this.sdk.requestForRealm<ManagementPermissionReference>(realmName, '/users-management-permissions', 'GET');
        } catch (error) {
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async updateUsersManagementPermissions(realmName: string, permissions: ManagementPermissionReference): Promise<ManagementPermissionReference> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
        ...
        try {
            return this.sdk.requestForRealm<ManagementPermissionReference>(realmName, '/users-management-permissions', 'PUT', permissions);
        } catch (error) {
    ...
    async convertClientDescription(realmName: string, description: string): Promise<any> {
        ...
        try {
            return this.sdk.requestForRealm<any>(realmName, '/client-description-converter', 'POST', description);
        } catch (error) {
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async getLocalizationTexts(realmName: string, locale: string, useRealmDefaultLocaleFallback?: boolean): Promise<Record<string, string>> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async addLocalizationTexts(realmName: string, locale: string, texts: Record<string, string>): Promise<void> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async updateLocalizationText(realmName: string, locale: string, key: string, text: string): Promise<void> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
        ...
        try {
            await this.sdk.requestForRealm<void>(realmName, `/localization/${locale}/${key}`, 'PUT', text);
        } catch (error) {
     ...
     * @throws {Error} If the request fails or parameters are invalid
     */
    async deleteUserSession(realmName: string, sessionId: string, isOffline?: boolean): Promise<void> {
        if (!realmName) {
            throw new Error('Realm name is required');
        }
