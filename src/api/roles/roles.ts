...
export class RolesApi {
  ...
  async list(query?: RoleQuery): Promise<RoleRepresentation[]> {
    try {
      ...
      throw new Error(
        `Failed to list realm roles: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async create(role: RoleRepresentation): Promise<string> {
    ...
    try {
      ...
      throw new Error(
        `Failed to create realm role: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getByName(name: string): Promise<RoleRepresentation> {
    ...
    try {
      ...
      throw new Error(
        `Failed to get realm role: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async update(name: string, role: RoleRepresentation): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to update realm role: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async delete(name: string): Promise<void> {
    ...
    try {
      ...
      throw new Error(
        `Failed to delete realm role: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getClientRoleComposites(name: string, clientId: string): Promise<RoleRepresentation[]> {
    ...
    try {
      return this.sdk.request<RoleRepresentation[]>(
        `/roles/${name}/composites/clients/${clientId}`,
        'GET'
      );
    } catch (error) {
      console.error(
        `Error getting client composites for role ${name} and client ${clientId}:`,
        error
      );
      throw new Error(
  ...
  async getUsersWithRole(
    ...
    try {
      ...
      throw new Error(
        `Failed to get users with role: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getGroupsWithRole(
    ...
    try {
      ...
      throw new Error(
        `Failed to get groups with role: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
  ...
  async getPermissions(name: string): Promise<ManagementPermissionReference> {
    ...
    try {
      return this.sdk.request<ManagementPermissionReference>(
        `/roles/${name}/management/permissions`,
        'GET'
      );
    } catch (error) {
      console.error(`Error getting permissions for role ${name}:`, error);
      throw new Error(
        `Failed to get role permissions: ${error instanceof Error ? error.message : String(error)}`
      );
    }
  }
